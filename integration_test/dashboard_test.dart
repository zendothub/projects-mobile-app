...
import 'package:zen_mobile/screens/MainScreens/Home/Dashboard/dash_board_screen.dart';
...
void main() {
  ...
  setUp(() {
    ...
    //     .thenReturn(WorkspaceModel.initialize(workspaceName: 'TESTER', workspaceLogo: ''));
