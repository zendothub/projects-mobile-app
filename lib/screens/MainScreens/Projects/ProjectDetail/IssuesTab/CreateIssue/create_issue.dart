...
import 'package:zen_mobile/bottom_sheets/issues_list_sheet.dart';
import 'package:zen_mobile/bottom_sheets/selectProjectSheet.dart';
import 'package:zen_mobile/bottom_sheets/select_estimate.dart';
import 'package:zen_mobile/bottom_sheets/select_issue_labels.dart';
import 'package:zen_mobile/bottom_sheets/select_priority.dart';
import 'package:zen_mobile/bottom_sheets/select_project_members.dart';
import 'package:zen_mobile/bottom_sheets/select_states.dart';
import 'package:zen_mobile/config/config_variables.dart';
import 'package:zen_mobile/config/const.dart';
import 'package:zen_mobile/mixins/widget_state_mixin.dart';
import 'package:zen_mobile/provider/provider_list.dart';
import 'package:zen_mobile/provider/theme_provider.dart';
import 'package:zen_mobile/screens/MainScreens/Projects/ProjectDetail/IssuesTab/CreateIssue/selected_label_widget.dart';
...
import 'package:zen_mobile/utils/editor.dart';
                                                  ...
                                                  children: [
                                                    InAppWebView(
                                                        ...
                                                        initialUrlRequest:
                                                            URLRequest(
                                                                url: Uri.parse(
                                                                    '${Config.webUrl!}m/${ref.read(ProviderList.workspaceProvider).selectedWorkspace.workspaceSlug}/editor?editable=false') as WebUri)),
                                                    descriptionLoading
                                                        ? Container(
                                                            alignment: Alignment
                                                                .center,
