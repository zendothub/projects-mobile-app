class UserSettingModel {
  ...
  static UserSettingModel initialize() {
    return UserSettingModel(
      id: '',
      email: '',
      workspace: WorkspaceModel.initialize(workspaceName: '', workspaceLogo: ''),
    );
  }
}
...
class WorkspaceModel {
  ...
  static WorkspaceModel initialize({required String workspaceName, required String workspaceLogo}) {
    return WorkspaceModel(
      lastWorkspaceId: '',
      lastWorkspaceSlug: '',
      fallbackWorkspaceId: '',
